    ...
    return (
        <div className="w-full justify-center items-center pt-12 bg-[#000000] ">
            <div className=" flex flex-row justify-between w-[90%] xl:max-w-7xl  mx-auto">
                ...
                />
                <div className=" bg-[#0E0E0E] border border-[#1A1A1A] px-5 xl:flex xl:flex-row hidden justify-between items-center w-[354px] rounded-full">
                    <a
                        href=""
                ...
                <div className="bg-[#CEEF08] text-black justify-center items-center rounded-full px-4 xl:hidden flex py-2"
                >
