        ...
        >
            <div className="flex xl:flex-row lg:flex-row flex-col justify-between w-[90%] lg:w-[90%] xl:max-w-7xl mx-auto mt-1 lg:mt-14 xl:mt-12">
                    ...
                    <div>
                        ...
                        <div className="xl:w-[530px] w-[100%] lg:w-[560px] relative">
                            <p className="font-poppinsRegular text-white xl:text-[20.3px] lg:text-[22px] text-[16px] mt-6 font-normal">
                                Funding your Monita wallet has never been simpler! Whether you’re receiving money from friends, family, or funding it yourself.                            </p>
                            {/* <div className="absolute lg:left-[300px] left-[220px] top-[101px] lg:top-[60px] mb-10 z-40">
                                <AnimatedSVG />
                            </div> */}
                        </div>
                ...
                <div className="xl:w-[50%] w-full flex flex-col justify-end items-end mt-10">
                    <img
                        src={images.image.RMoneyHeroImg}
                        alt="Hero Image"
