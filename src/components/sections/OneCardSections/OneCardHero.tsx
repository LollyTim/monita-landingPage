                    ...
                    <div>
                        ...
                        <div className="xl:w-[500px] w-[100%] lg:w-[500px] relative">
                            <p className="font-poppinsRegular text-white xl:text-[20.3px] lg:text-[22px] text-[16px] mt-6 font-normal">
                                Experience seamless spending locally and globally with the Monita One Card.
                            </p>
                            <div className="absolute lg:left-[200px] left-[280px] top-[25px] lg:top-[35px] mb-10 z-40">
                                <AnimatedSVG />
                            </div>
                        </div>
